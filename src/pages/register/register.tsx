        ...
        <View>
          ...
          <View className="input-row">
            <View className="input">
              <Input value={firstName} onInput={e=>setFirstName(e.target.value)} type="text" placeholder="姓氏"></Input>
            </View>
            <View className="input">
              <Input value={lastName} onInput={e=>setLastName(e.target.value)}  type="text" placeholder="名字"></Input>
            </View>
          </View>
